...
对于实战中遇到原理好奇的朋友，我们也准备了硬核的排坑记录：- 📙 [装机开荒：几十块钱的 UFSD 优盘榨干系统盘读写速度](./docs/04_ufsd_bootable_usb_guide.md)- 📕 [依赖填坑：彻底解决向日葵缺少 libgconf-2-4 依赖报错](./docs/01_sunlogin_libgconf2_fix.md)
